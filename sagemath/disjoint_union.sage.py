...
# This file was *autogenerated* from the file ./disjoint_union.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_6 = Integer(6)#!/usr/local/bin/sage
...
def test():
    G = graphs.CycleGraph(_sage_const_6 ).disjoint_union(graphs.CycleGraph(_sage_const_6 ))
    G.relabel()

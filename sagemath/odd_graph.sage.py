...
# This file was *autogenerated* from the file ./odd_graph.sage
...
def permutation_module_constituents(k):
    T = []
    for i in range(_sage_const_1 ,ceil(float((_sage_const_2 *k+_sage_const_1 ))/_sage_const_2 )):
        T.append([_sage_const_2 *k+_sage_const_1 -i,i])
    return [[_sage_const_2 *k+_sage_const_1 ]] + T
#n = int(sys.argv[1])
...
W = weights(_sage_const_2 *k+_sage_const_1 ,k,[[n-_sage_const_3 ,_sage_const_3 ],[n-_sage_const_4 ,_sage_const_2 ,_sage_const_2 ],[n-_sage_const_2 ,_sage_const_1 ,_sage_const_1 ],[n-_sage_const_3 ,_sage_const_2 ,_sage_const_1 ],[n-_sage_const_4 ,_sage_const_3 ,_sage_const_1 ],[n-_sage_const_1 ,_sage_const_1 ]],T)
print eigenvalues_weights(n,k,W[_sage_const_1 ])

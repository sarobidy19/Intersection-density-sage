...
# This file was *autogenerated* from the file ./t-setwise.sage
...
def weights(n,L,M):
    ...
    for chi in char:
        ...
        if phi.values() == [_sage_const_1 ]*len(SymmetricGroup(n).conjugacy_classes_representatives()):
            Eq.append(t == factorial(_sage_const_3 )*binomial(n,_sage_const_3 )-_sage_const_1 )  ######## maximum eigenvalue
        else:
...
#Alt = alt_char(n)
#print Alt
W = weights(n,[[n],[n-_sage_const_1 ,_sage_const_1 ],[n-_sage_const_2 ,_sage_const_2 ],[n-_sage_const_2 ,_sage_const_1 ,_sage_const_1 ],[n-_sage_const_3 ,_sage_const_3 ],[n-_sage_const_3 ,_sage_const_2 ,_sage_const_1 ],[n-_sage_const_4 ,_sage_const_2 ,_sage_const_2 ]],[[n],[n-_sage_const_1 ,_sage_const_1 ],[n-_sage_const_2 ,_sage_const_2 ],[n-_sage_const_2 ,_sage_const_1 ,_sage_const_1 ],[n-_sage_const_3 ,_sage_const_3 ],[n-_sage_const_3 ,_sage_const_1 ,_sage_const_1 ,_sage_const_1 ],[n-_sage_const_3 ,_sage_const_2 ,_sage_const_1 ]])

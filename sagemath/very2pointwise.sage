...
def weights(n,L,M):
    ...
    for chi in char:
        ...
        if phi.values() == [1]*len(SymmetricGroup(n).conjugacy_classes_representatives()):
            Eq.append(t == (n-1)*n -1)  ######## maximum eigenvalue
        else:
...
Alt = alt_char(n)
print Alt
#W = weights(n,[[n],[n-1,1],[n-2,2],[n-3,2,1],[n-3,3]],[[n],[n-1,1],[n-2,2],[n-2,1,1],[n-1,1]])
#W = weights(n,[[n-2,2],[n-1,1],[n-4,3,1],[n-3,2,1],[n-3,3]],[[n],[n-1,1],[n-2,2],[n-2,1,1],[n-1,1]])works for odd


#W = weights(n,[[n],[n-3,2,1],[n-1,1],[n-2,2],[n-4,2,2]],[[n],[n-1,1],[n-2,2],[n-2,1,1],[n-1,1]]) #works for even
#W = weights(n,[[n],[n-3,2,1],[n-1,1],[n-2,2],[n-3,3]],[[n],[n-1,1],[n-2,2],[n-2,1,1],[n-1,1]]) #works for odd
#W = weights(n,[[n],[n-1,1],[n-2,2],[n-3,3],[n-3,2,1],[n-4,3,1]],[[n],[n-1,1],[n-2,2],[n-2,1,1],[n-1,1],[n-2,2]]) #should work#
#W = weights(n,[[n-3,2,1],[n-1,1],[n-2,2],[n-3,3],[n-4,2,2]],[[n],[n-1,1],[n-2,2],[n-2,1,1],[n-1,1]])

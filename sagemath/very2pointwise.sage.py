...
# This file was *autogenerated* from the file ./very2pointwise.sage
...
def weights(n,L,M):
    ...
    for chi in char:
        ...
        if phi.values() == [_sage_const_1 ]*len(SymmetricGroup(n).conjugacy_classes_representatives()):
            Eq.append(t == (n-_sage_const_1 )*n -_sage_const_1 )  ######## maximum eigenvalue
        else:
...
def eigenvalues_weights(n,W):
    ...
    for psi in Irr:
        ...
        eigenvalues.append(s)
        print (s,psi)
        if psi.degree() == binomial(n-_sage_const_1 ,_sage_const_2 )-_sage_const_1 :
...
W = weights(n,[[n],[n-_sage_const_1 ,_sage_const_1 ],[n-_sage_const_2 ,_sage_const_2 ],[n-_sage_const_3 ,_sage_const_2 ,_sage_const_1 ],[n-_sage_const_3 ,_sage_const_3 ]],[[n],[n-_sage_const_1 ,_sage_const_1 ],[n-_sage_const_2 ,_sage_const_2 ],[n-_sage_const_2 ,_sage_const_1 ,_sage_const_1 ],[n-_sage_const_1 ,_sage_const_1 ]])
